...
import TelegramLogin from "@/components/TelegramLogin"; // Add Telegram Widget
...
export function Login() {
  ...
  // Add handler for Telegram authentication
  const handleTelegramAuth = async (telegramUser: any) => {
    try {
      ...
      if (data.success) {
        // You'll need to handle the session here
        // This might involve calling a custom login mutation or redirecting
        setLocation("/");
      }
    } catch (error) {
